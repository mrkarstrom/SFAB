	...
	<div class="w-full h-auto max-w-[1200px] bg-secondary flex flex-col">
		...
		<div class="content-container grid grid-cols-2 h-auto">
			<div class="left-side flex flex-col items-center w-full">
				<div class="DG-card h-auto p-5 w-full">
				...
				<div class="WF-card h-auto w-[60%] pt-20 pb-10">
					<div class="title-text font-medium leading-6 pb-1">
						<h4 class="">WEEK Fashion</h4>
					</div>
			...
			<div class="right-side bg-black h-full w-full">Hello</div>
		</div>
	</div>
</div>
