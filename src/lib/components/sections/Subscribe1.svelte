	...
	<section class="flex flex-col align-start items-between space-y-20 py-10 pl-20">
		<div class="newsletter-signup">
			...
			<form action="" class="flex flex-row items-center">
				<input
					class="h-12 w-80 pl-8 text-sm rounded bg-secondary border m-0"
					type="text"
					name="inputName"
		...
		<div id="download-app-figure" class="card rounded-md h-full w-[250px] bg-secondary drop-shadow-md mr-2">
