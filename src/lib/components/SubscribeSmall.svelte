...
>
	<img
		...
		class="w-[var(--bottomBannerHeight)] rotate-90 absolute -translate-y-[180px]"
		alt="Download App"
	/>
	<div id="newsletter-signup" class="pt-20 w-full px-10 mt-[var(--bottomBannerHeight)]">
	...
	<h5 class="pb-4 text-2xl w-full px-10 mt-6">Join our community and be part of the exciting launch</h5>
